  ...
  <div class="container">
    <div class="row d-flex justify-content-between mt-3 mb-4">
      ...
      <div class="col-md-1" style="margin-top: auto; margin-bottom: auto; text-align: end;">
        <button class="btn btn-outline-primary addButton" @click="showModal = true, city_id = '1', user_id = '', name = '', description = '', duration = '', price = '', kind = 'Городской', type = 'Групповой'"><i class="fas fa-plus"></i></button>
      </div>
    </div>
